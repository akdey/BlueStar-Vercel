...
const PrintableDocument: React.FC<PrintableDocumentProps> = ({ document }) => {
    // 1. Fetch Party Details
    const { data: partyData } = useGetPartyQuery(document?.party_id, {
        skip: !document?.party_id
    });
    ...
    // Fallback to document's embedded party info if fetch hasn't loaded or failed, 
    ...
    const theme = getTheme(document.doc_type);
            ...
            <div className="printable-content bg-white p-12 text-slate-900 w-full max-w-[210mm] min-h-[297mm] mx-auto shadow-2xl relative font-sans">
                ...
                <div className="flex justify-between items-start mb-12 relative z-10">
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-sm font-bold text-slate-400">#{document.doc_number || 'TRP-DRAFT'}</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-16 mb-12 relative z-10">
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-1.5 text-xs">
                            <p className="font-bold text-sm text-slate-900 mb-2">BLUE STAR TRADING & CO.</p>
                            <p className="flex items-start gap-2 text-slate-600 leading-snug">
                                <MapPin size={12} className={`mt-0.5 ${theme.accent}`} />
                                <span className="max-w-[200px]">Srirampur, Ratulia, Paschim Medinipur, 721139</span>
                            </p>
                            ...
                            <p className="flex items-center gap-2 text-slate-600">
                                ...
                                bluestartradingandco@gmail.com
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-1.5 text-xs">
                            <p className="font-bold text-sm text-slate-900 uppercase mb-2">
                                {party?.name || document.party_name || 'Unknown Party'}
                            </p>
                ...
                <div className={`${theme.lightBg} rounded-xl p-6 grid grid-cols-3 gap-8 mb-12 border ${theme.border} border-opacity-10`}>
                    <div>
                        ...
                        <div className="flex items-center gap-2 font-bold text-slate-800 text-sm">
                            ...
                            {new Date(document.doc_date).toLocaleDateString(undefined, { dateStyle: 'long' })}
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="flex items-center gap-2 font-bold text-slate-800 text-sm">
                            ...
                            {document.place_of_supply || 'West Bengal'}
                        </div>
                    </div>
                    <div>
                        <p className="text-[8px] font-black uppercase tracking-widest text-slate-500 mb-1">Document Status</p>
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        {document.notes && (
                            <div className="bg-slate-50 p-3 rounded-lg border border-slate-100">
                                ...
                                <p className="text-[10px] text-slate-600 italic">"{document.notes}"</p>
                            </div>
                        )}
                    </div>
